            ...
            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$a->id}}</td>
                        <td>{{$a->name}}</td>
                        <td><img src="{{url('upload/'.$a->image)}}" style="width:150px; height:100px; border-radius=50%"></td>

                        <td>
                            <a href="{{url('admin/category/view/'.$a->id)}}" class="btn btn-primary">View</a>
                            <a href="{{url('admin/category/edit/'.$a->id)}}" class="btn btn-warning">edit</a>
                            <a href="{{url('admin/category/delete/'.$a->id)}}" class="btn btn-warning">delete</a>
                        </td>
                    </tr>
